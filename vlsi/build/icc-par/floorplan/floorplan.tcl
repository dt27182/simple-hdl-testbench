...
create_floorplan \
        -control_type width_and_height -core_width 2200 -core_height 1500 \
        -flip_first_row \
        -start_first_row \
        -left_io2core 5 \
        -bottom_io2core 5 \
...
set_fp_macro_array -name dcache -elements [list [get_cells "Tile/dcache/data/T6/sram Tile/dcache/data/T29/sram Tile/dcache/data/T67/sram Tile/dcache/data/T90/sram Tile/dcache/meta/tags/sram"]] -x_offset 10 -y_offset 10 -align_edge top -rectilinear
set_fp_macro_array -name icache -elements [list [get_cells "Tile/icache/icache/T161/sram Tile/icache/icache/T179/sram Tile/icache/icache/tag_array/sram"]] -x_offset 10 -y_offset 10 -align_edge bottom -rectilinear
set_fp_macro_array -name llc -elements [list [get_cells "uncore/outmemsys/llc/data/data/T20/sram uncore/outmemsys/llc/data/data/T39/sram uncore/outmemsys/llc/data/data/T72/sram uncore/outmemsys/llc/data/data/T91/sram uncore/outmemsys/llc/tags/T3/sram uncore/outmemsys/llc/data/data/T144/sram uncore/outmemsys/llc/data/data/T177/sram uncore/outmemsys/llc/data/data/T196/sram uncore/outmemsys/llc/data/data/T125/sram"]] -x_offset 10 -y_offset 10 -align_edge top -rectilinear
