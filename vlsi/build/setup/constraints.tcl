...
set_ungroup [get_designs FPUFMAPipe_0] false
set_ungroup [get_designs FPUFMAPipe_1] false
set_ungroup [get_designs LaneMul] false
set_ungroup [get_designs LaneConv] false
set_ungroup [get_designs LaneFMA] false
...
#set_optimize_registers true -design FPUFMAPipe_1 -clock clk -check_design -verbose -print_critical_loop
